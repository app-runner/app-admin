...
@AnnoMain(name = "应用版本", annoOrder = @AnnoOrder(orderValue = "versionNum", orderType = "desc"))
public class AppVersion extends BaseMetaModel {

    @AnnoField(title = "主键", show = false, fieldSize = 32)
    ...
    @AnnoField(
        title = "状态", edit = @AnnoEdit, dataType = AnnoDataType.OPTIONS, optionType = @AnnoOptionType({
